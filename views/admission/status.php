...
<div class="right-column sisu">
    <div class="row mx-0">
        <div class="col-md-7 order-md-2 signin-right-column px-5 bg-dark-green">
            ...
            <h1 class="display-4" style="color: white;" >Welcome to Admission Unit</h1>
        ...
        <div class="col-md-5 order-md-1 signin-left-column bg-white px-5">
            ...
            <form  method="POST" action="" >
                <div class="form-group">
                    <label for="username">Jamb Registration Number</label>
                    <input type="text" class="form-control" id="jamb" name="jamb"  required autofocus  placeholder="Enter jamb reg number">
