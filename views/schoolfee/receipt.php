...
<div class="receipt-main col-xs-10 col-sm-10  col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
    <div class="receipt-header">
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="receipt-left">
                <img class="img-responsive" alt="" src="<?= Url::home('/'.Auth::user()->photo)?>" style="width: 71px; border-radius: 43px;">
            </div>
        </div>
        <div class=" text-right">
            <div class="receipt-right">
                <h5>FEDERAL UNIVERSITY OF TECHNOLOGY OWERRI.</h5>
                <p>+91 12345-6789 <i class="fa fa-phone"></i></p>
                <p>info@gmail.com <i class="fa fa-envelope-o"></i></p>
                <p>Imo Nigeria <i class="fa fa-location-arrow"></i></p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="receipt-header receipt-header-mid">
            <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                <div class="receipt-right">
                    <h5><?= Auth::user()->fname?> <?= Auth::user()->lname?><small>  |   Reg Number : <?= Auth::user()->reg_no?></small></h5>
                    <p><b>Mobile :</b> <?= Auth::user()->phone1?></p>
    ...
    <div>
        <table class="table table-bordered">
            ...
            ?>
            <tr>
                <td class="col-md-9"><?=$b->type?></td>
                <td class="col-md-3">₦ <?=$b->amount?>/-</td>
            </tr>
            <?php
            }
            ?>
